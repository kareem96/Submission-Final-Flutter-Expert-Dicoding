...
void main(){
  ...
  blocTest<TvTopRatedBloc, TvTopRatedState>(
    ...
    build: () {
      when(mockGetTvTopRated.execute()).thenAnswer((_) async => Right(testTVShowList));
  ...
  blocTest<TvTopRatedBloc, TvTopRatedState>(
    ...
    build: () {
      when(mockGetTvTopRated.execute()).thenAnswer((_) async => Left(ServerFailure('Server Failure')));
      return tvTopRatedBloc;
    },
    act: (bloc) => bloc.add(OnTvTopRated()),
    expect: () => [
  ...
  blocTest<TvTopRatedBloc, TvTopRatedState>(
    ...
    build: () {
      when(mockGetTvTopRated.execute()).thenAnswer((_) async => const Right([]));
      return tvTopRatedBloc;
    },
    act: (bloc) => bloc.add(OnTvTopRated()),
    expect: () => [
